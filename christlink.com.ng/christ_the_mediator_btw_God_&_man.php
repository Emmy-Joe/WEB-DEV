...
<html lang="en">
  <head>
  <title>CHRIST – MEDIATOR BETWEEN GOD AND MAN | CLIF - Seeking The Kingdom of God & His Righteousness...</title>
    ...
    <div class="container">
      ...
      <div class="row mb-5 justify-content-center">
        <div class="col-md-8 text-center">
          <h2 class="text-black h1 site-section-heading text-center">CHRIST – MEDIATOR BETWEEN GOD AND MAN</h2>
          <hr>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-10">
          <div class="p-3 box-with-humber" style="font-family: 'Times New Roman', Times, serif; font-size: xx-large;">
            ...
            <p> 
              <ol>
                <li><a href="#p1">Human Remedy to The Sin Problem</a></li>
                <li><a href="#p2">Atonement In the Old Testament</a></li>
                <li><a href="#p3">Christ: The Perfect Sacrifice for Sin</a></li>
              </ol>
            </p> 
            ...
            <ol>
              <li id="p1"> <b>HUMAN REMEDY TO THE SIN PROBLEM</b>
                <p>
                ...
                <ol type="I">
                  ...
                  From the case of David and Bathsheba in Psalm 51:1-12, we note the following about the sinner‟s proper disposition to God and to his sin:
                    <ol type="I">
                      <li>Every attempt of David to cover his sin did not prosper; it only led him deeper into sin (Proverbs 28:13). This is a wrong disposition.</li>
                      <li>David eventually pleaded for mercy when his sin was discovered. To plead for mercy indicates the need for propitiation – the turning away of God's wrath from the sinner.</li>
                      <li>He asked for the removal of his sins from Go's sight and divine washing. That points to the need for expiation. Sin has a polluting influence on the sinner. Expiation is the divine act of covering sin and cleansing the sinner's heart for a renewed walk with God.</li>
                      <li>He made a specific confession – “this evil.” Sin must be viewed as evil. The attitude in genuine confession is that of sincerity. God desires the truth in the inward part. He requires a broken spirit and a contrite heart. Confession of sin must be honest and specific.</li>
                      <li>He prayed for purging with hyssop, typifying the need for blood. Confession of sin is mandatory. But David knew that confession alone could not save him; he needed cleansing by blood (Exodus 12:22; Leviticus 14:4-6, 49-53; Num. 19:1-9; 16-21; Heb. 9:18-20).</li>
                      <br>
                      <p>David felt the guilt; that is why he asked for forgiveness. Sin is primarily against God. So, it is only He who has the power to forgive sin. And guilt is the right feeling for sin, just like pain or inconvenience is felt in sickness. As the sick seek the physician, so should every sinner seek God for cleansing and justification. As David could not cleanse himself but asked God for cleansing and a renewed spirit, so should every sinner look to God for salvation and purity today (Isaiah 45:22).</p>
                    </ol>
                  </p>
                </li>
                  ...
                  <li id="p2"> <b>ATONEMENT IN THE OLD TESTAMENT</b>
                    <p>
                    ...
                    <li id="p3"> <b>CHRIST: THE PERFECT SACRIFICE FOR SIN</b>
                        <p>
